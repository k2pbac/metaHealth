      ...
      <div className="row">
        <div className="col-md-4">
          <div className="selection-panel" onClick = {onPatientRegister}>
            <Image className="selection-image1" src={patient_image} alt="Patient"></Image>
            <div className="content">
              <h3>Patient <br/> Registration</h3>
            </div>
          </div>
        </div>
        <div className="col-md-4">
          <div className="selection-panel" onClick = {onEmployeeRegister}>
            <Image className="selection-image2" src={employee_image} alt="Employee"></Image>
            <div className="content">
              <h3>Employee <br/> Registration</h3>
            </div>
          </div>
        </div>
      </div>
