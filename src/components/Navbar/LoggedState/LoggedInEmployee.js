  ...
  const {name, onLogout, avatar} = props;
   ...
   <nav className = {navClass}>
     ...
     <div className = "right-side">
       ...
       <Image className = "avatar-image" src={avatar} alt={name} roundedCircle></Image>
       ...
       <Dropdown className = "dropdown">
          ...
          <Dropdown.Menu>
            ...
            <Dropdown.Item href="#/action-2">Manage Clinic Appointments</Dropdown.Item>
            <Dropdown.Item href="#/action-3">View Patient Medical Records</Dropdown.Item>
          </Dropdown.Menu>
        </Dropdown>     
